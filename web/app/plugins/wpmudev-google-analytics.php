...
function wpmudev_google_analytics() { ?>
	...
	<script type="text/javascript">
	    window.cookieconsent_options = {"message":"<?php echo __('This website uses cookies to ensure you get the best experience on our website', 'omega-td')?>","dismiss":"<?php echo __('Got it', 'omega-td')?>","learnMore":"<?php echo __('More info', 'omega-td')?>","link":"<?php echo __('cookie link', 'omega-td')?>","theme":"dark-bottom"};
	</script>
