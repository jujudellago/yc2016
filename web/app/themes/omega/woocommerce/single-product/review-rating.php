...
if ( $rating && get_option( 'woocommerce_enable_review_rating' ) == 'yes' ) { ?>
	<a itemprop="reviewRating" itemscope itemtype="http://schema.org/Rating" class="star-rating" title="<?php echo sprintf( esc_attr__( 'Rated %d out of 5', 'woocommerce' ), esc_attr( $rating ) ) ?>" data-toggle="tooltip">
